...
This repository documents my **complete Java learning journey at BridgeLabz**, organized **week-wise and day-wise**, covering **Core Java fundamentals, scenario-based problem solving, LeetCode practice, and Object-Oriented Programming (OOP)**.

The project follows a **clear hierarchical folder structure** for easy navigation and maintainability.
...
🔗 Code Link:
👉 [https://github.com/Shifa-Khan-05/BridgeLabz-Training/tree/core-java-practice/gcr-codebase/program-prerequisites](https://github.com/Shifa-Khan-05/BridgeLabz-Training/tree/core-java-practice/gcr-codebase/program-prerequisites)
...
🔗 Code Link:
👉 [https://github.com/Shifa-Khan-05/BridgeLabz-Training/tree/core-java-practice/gcr-codebase/programming-elements](https://github.com/Shifa-Khan-05/BridgeLabz-Training/tree/core-java-practice/gcr-codebase/programming-elements)
...
🔗 Code Link:
👉 [https://github.com/Shifa-Khan-05/BridgeLabz-Training/tree/core-java-practice/gcr-codebase/java-methods](https://github.com/Shifa-Khan-05/BridgeLabz-Training/tree/core-java-practice/gcr-codebase/java-methods)
...
🔗 Code Link:
👉 [https://github.com/Shifa-Khan-05/BridgeLabz-Training/tree/core-java-practice/gcr-codebase/java-strings](https://github.com/Shifa-Khan-05/BridgeLabz-Training/tree/core-java-practice/gcr-codebase/java-strings)
...
### 🔹 Day 2: Constructors, Access Modifiers & Encapsulation
...
## 📘 Week 6 – Day 3: Java 8 | Lambdas & Stream API – Real-World Scenarios

On **Day 3 of Week 6**, I worked on **real-time, scenario-based problems** using **Java 8 Lambda Expressions and Stream API**.
The focus was on **functional programming**, **data filtering**, **sorting**, **grouping**, and **analytics** across multiple real-world domains.

---

## 🧠 Core Java 8 Concepts Applied

* **Lambda Expressions** for concise business logic
* **Stream API** for filtering, mapping, sorting, and aggregation
* **Functional-style programming**
* **Comparator & Predicate usage**
* **Collection-to-Stream transformations**
* **Real-world analytics using streams**
...
* Pass/fail validation using lambdas
* Sorting by name, rank, and age
* Filtering students based on age, rank, city, and department
* Grouping, averaging, min/max ranking using Stream API
* Advanced queries using `map`, `filter`, `sorted`, `limit`, `groupingBy`, `partitioningBy`, `flatMap`
...
* Gender-wise and department-wise analytics
* Highest, lowest, and top-paid employee queries
* Experience and joining-year based filtering

---

### 🛒 Shopping / E-Commerce

* Discount calculation using lambdas
...
* Balance comparison using lambdas
...
* Logging and printing via `forEach()`
...
## 📘 Week 7 – Day 1: Design Patterns | Smart University Library Management System

On **Day 1 of Week 7**, I worked on a **real-world, scenario-based application** to understand how **multiple design patterns can coexist** in a single system.
The focus was on **scalability, consistency, loose coupling, and extensibility** using core Java Design Patterns.

---

## 🧠 Design Patterns Applied

### 🔹 Singleton – Centralized Library Catalog

* Ensured only **one instance** of `LibraryCatalog` exists across the campus
* Prevented inconsistencies in book data
* Provided a global access point for catalog operations

---

### 🔹 Factory – Dynamic User Creation

* Created users at runtime based on role:
...
* Allowed users to **subscribe for book availability**
* Automatically notified multiple users on catalog updates
* Ideal for waitlists and new arrival alerts

---

### 🔹 Builder – Flexible Book Construction

* Built `Book` objects with optional attributes:

  * Authors
  * Editions
  * Genres / Sub-genres
  * Publisher details
* Avoided complex constructors
...
* Flexible and clean object creation
* Integrated mini-project using multiple patterns

---

## 📌 Learning Outcomes

✔ Understood when and why to use different design patterns
✔ Learned how patterns collaborate in a real system
✔ Improved design thinking and architectural skills
✔ Built a scalable and extensible Java application

---

## 🔗 Code Link – Smart University Library System
